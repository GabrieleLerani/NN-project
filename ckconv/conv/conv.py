...
def conv1d(
    ...
    return torch.nn.functional.conv1d(
        x, kernel, bias=bias, padding=padding, stride=1, groups=groups
    )
...
def conv(
    ...
    return get_conv_function(
        x, kernel, bias, padding=0 if causal else padding, groups=groups, dim=data_dim
    )
